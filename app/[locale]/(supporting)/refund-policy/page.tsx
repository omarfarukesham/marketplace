  ...
  return (
    ...
    <main className='relative border-t-[1px] border-secondary-500 bg-[#fffaee] bg-cover bg-center bg-no-repeat pb-10'>
      ...
      <div className='relative z-1'>
        <h1 className='pt-10 text-center text-3xl font-extrabold uppercase text-black'>Refund Policy</h1>
        <div className='grid justify-center pb-10 pt-5'>
          <p className='max-w-5xl px-2 text-center text-black'>
            Thank you for using Alipo! These Terms of Use (&quot;Terms&quot;) contain the rules and restrictions that
            govern your use of our applications, products, services and websites (&quot;Services&quot;).
          </p>
        </div>
