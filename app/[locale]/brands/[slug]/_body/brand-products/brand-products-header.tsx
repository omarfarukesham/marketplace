...
const BrandProductsHeader = ({ name }: { name: string }) => {
  const context = getClientContext();
  const searchParams = useSearchParams();

  return (
    <div className='flex items-center justify-between'>
      <h2 className='hidden text-base font-bold md:block md:text-lg'>All Products of {name}</h2>
...
export default BrandProductsHeader;
